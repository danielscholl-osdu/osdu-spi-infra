---
title: "ADR-0007: Karpenter NodePools for Workload Isolation"
description: Dedicated Karpenter NodePools separate platform middleware from OSDU services with per-stack isolation
---
